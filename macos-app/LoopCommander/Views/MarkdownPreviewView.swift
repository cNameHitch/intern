        ...
        do {
            ...
            for run in result.runs {
                ...
                if let intent = run.presentationIntent {
                    for component in intent.components {
                        if case .header(let level) = component.kind {
                            ...
                            result[range].foregroundColor = Color(hex: "e2e8f0") // lcTextPrimary
                        }
                    }
                }
                ...
                if let inlineIntent = run.inlinePresentationIntent, inlineIntent.contains(.code) {
                    ...
                    result[range].foregroundColor = Color(hex: "a5b4fc") // lcAccentLight
                }
            ...
            container.foregroundColor = Color(hex: "e2e8f0") // lcTextPrimary
            ...
            plain.foregroundColor = Color(hex: "e2e8f0")
            return plain
        }
    }
