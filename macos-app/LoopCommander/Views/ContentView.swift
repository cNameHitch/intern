...
extension Notification.Name {
    static let newTask = Notification.Name("com.loopcommander.newTask")
    static let refreshData = Notification.Name("com.loopcommander.refreshData")
    static let switchToTasks = Notification.Name("com.loopcommander.switchToTasks")
    static let switchToLogs = Notification.Name("com.loopcommander.switchToLogs")
                ...
                Group {
                    if let taskId = selectedTaskId {
                        ...
                        VStack(spacing: 12) {
                            ...
                            Text("Choose a task from the list to view details")
                                .font(.lcCaption)
