//! Event broadcasting and serialization for the Loop Commander daemon.
//!
//! The `DaemonEvent` enum is defined in `lc-core`. This module provides
...
/// ```
/// use lc_core::DaemonEvent;
/// use lc_daemon::events::event_to_notification;
///
